...
class B2C_Controller extends Controller
{
    ...
    public function transaction(Request $request)
    {
        $data = json_encode([
            ...
            'QueueTimeOutURL'    => route('b2c.transaction.callback'),
            'ResultURL'          => route('b2c.transaction.callback'),
    ...
    public function status(Request $request)
    {
        $data = json_encode([
            ...
            'SecurityCredential' => $this->credentials,
            'QueueTimeOutURL'    => route('b2c.status.callback'),
            'ResultURL'          => route('b2c.status.callback'),
    ...
    public function balance()
    {
        $data = json_encode([
            ...
            'Initiator'          => $this->initiatorUsername,
            'SecurityCredential' => $this->credentials,
            'QueueTimeOutURL'    => route('b2c.balance.callback'),
            'ResultURL'          => route('b2c.balance.callback')
        ]);
